...
import br.com.estatistica.auxiliares.genericos.DSelecionarGenerico;
import br.com.estatistica.dao.IDAOGenerico;
import br.com.estatistica.modelo.IModelo;
import br.com.estatistica.tela.tablemodel.RowTableModel;
...
public class DSelecionarObjeto extends DSelecionarGenerico{
    ...
    public Object getColumn() {
        ...
        return ((RowTableModel) table.getModel()).getValueAt(l, c);
    }
    ...
    private void initComponents() {
            ...
            .addGroup(pnBuscaLayout.createSequentialGroup()
                ...
                .addGroup(pnBuscaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(pnBuscaLayout.createSequentialGroup()
                        ...
                        .addComponent(cbCampos, 0, 786, Short.MAX_VALUE))
                    .addGroup(pnBuscaLayout.createSequentialGroup()
                        .addComponent(lbBuscar)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(tfBuscar, javax.swing.GroupLayout.DEFAULT_SIZE, 786, Short.MAX_VALUE)))
                .addContainerGap())
        );
        ...
        pnOpcoesLayout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {btCancelar, btOk});
        ...
        setBounds((screenSize.width-881)/2, (screenSize.height-514)/2, 881, 514);
